...
INSERT INTO `tblProject`(`intProjectID`,`strProjectName`,`strProjectSponsor`,`strProjectDescription`,`dmtProjectStartDate`,`dmtProjectEndDate`,`strProjectTeamName`,`strProjectTeamLeader`,`strProjectSiteURL`) VALUES (1,'OPA','James','OPA IRS Tracker','2009-07-13','2011-12-31','OPAdmin','Robyn','http://cit3.ldl.swin.edu.au/~opadmin/'),(2,'MITUP',NULL,NULL,'2009-07-13',NULL,NULL,NULL,NULL),(3,'New Touch Laser Software',NULL,NULL,'2009-07-13',NULL,NULL,NULL,NULL),(4,'Online Project Timesheets',NULL,NULL,'2009-08-24',NULL,NULL,NULL,NULL);
INSERT INTO `tblMember`(`intMemberID`,`strMemberName`,`strMemberPassword`,`strMemberFirstName`,`strMemberLastName`,`strMemberEmail`) VALUES (1,'Mikhail','pass1','Mikhail','Kotov','gmail1@gmail.com'),(2,'Robyn','pass2','Robyn','Ius','gmail2@gmail.com'),(3,'Stephen','pass3','Stephen','Blatanic','gmail3@gmail.com');
