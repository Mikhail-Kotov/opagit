...
class Status {
    ...
    function displayStatus() {
        ...
        echo '<input type="image" alt="Edit Status" src="images/edit.gif" class="button" />' . "\n";
        echo "</div>\n";
        echo '</form></td>';
        ...
        echo '<input type="hidden" name="intSessionID" value="' . $this->sessionObj->getID() . '" />' . "\n";
        echo '<input type="hidden" name="s" value="' . $this->intStatusID . '" />' . "\n";
        echo '<input type="image" alt="PDF Status" src="images/pdf.gif" class="button" />' . "\n";
        echo "</div>\n";
        echo "</form></td><td>";
        ...
        echo '<input type="hidden" name="intSessionID" value="' . $this->sessionObj->getID() . '" />' . "\n";
        echo '<input type="hidden" name="s" value="' . $this->intStatusID . '" />' . "\n";
        echo '<input type="image" value="Delete" alt="Delete Status" src="images/delete.gif" class="button" />' . "\n";
        echo "</div>\n";
        echo "</form>\n";
        echo "</td></tr></table>";
...
//$arr3 = array();
        ...
        if (isset($historyTableArr[0])) {
            echo '<table border="0"  class="standard" cellspacing="0" >';//rules="all"  frame="void"
    ...
    function displayEditForm() {
        ...
        ?>
            ...
            <input type="image" value="Submit" src="images/submit.gif" alt="Submit"/>
        </form>
        <?php
    }
}
